...
public enum NotificationTypeEnum {
    General(1,"Thông tin chung", "" , DashboardController.PROFILE_GENERAL_URL,true, UserHandler.API_USER_REST_URL),
    Pssword(2,"Mật khẩu","", DashboardController.PROFILE_PASSWORD_URL,true, UserHandler.API_USER_PASSWORD_REST_URL),
    AddressValidate(3,"Xác minh địa chỉ", "", DashboardController.PROFILE_DOC_URL,true, UserHandler.API_USER_UPLOADOC_REST_URL),
